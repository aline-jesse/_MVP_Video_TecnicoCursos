...
export function computePerformanceMetrics(jobs: BasicRenderJob[]): PerformanceMetricsResult {
  ...
  return { 
    ...
    p50_render_time: pct(0.50),
    p90_render_time: pct(0.90),
...
// ---- Nova normalização semântica de erros ----
...
export function normalizeErrorMessage(msg: string): string {
  ...
  // Ordem de precedência: palavras mais específicas primeiro
